...
var data = [
    ...
    
    {
        ...
        person: 'Matthias Rungger (Hybrid Control Systems Group, TUM)',
		body: [{
			tag: 'p',
    ...
    
    {
        ...
        person: 'Christoph Kawan (Chair of Dynamical Systems, University of Passau)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Fritz Colonius (Chair of Control theory, University of Augsburg)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Bernhard Geiger and Rana Ali Amjad (Chair for Communications Engineering, TUM)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Wolfgang Kellerer (Chair of Communication Networks, TUM)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Michael Botsch (Technische Hochschule Ingolstadt)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Alex Leong (Chair of Automatic Control, University of Paderborn)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Steffen Linsenmayer (Institute for Systems Theory and Automatic Control, University of Stuttgart)',
		body: [{
			tag: 'p',
...

    {
        ...
        person: 'Daniel Quevedo (Chair of Automatic Control, University of Paderborn)',
		body: [{
			tag: 'p',
...

    {
        ...
        time: '11:00-11:45',
        title: 'TBA',
        person: 'Gerhard Kramer (Chair of Communication Networks, TUM)',
		body: [{
			tag: 'p',
			content: 'TBA'
		}]
...

    {
        ...
        person: 'Burak Demirel (Chair of Automatic Control, University of Paderborn)',
		body: [{
			tag: 'p',
...

    {
        ...
        time: '13:15-14:00',
        title: 'TBA',
        person: 'Wolfgang Utschick  (Chair of Signal Processing, TUM)',
		body: [{
			tag: 'p',
			content: 'TBA'
		}]
...

    {
        ...
        time: '14:00-14:45',
        title: 'TBA',
        person: 'Vahid Mamduhi (Chair of Information-oriented Control, TUM)',
		body: [{
			tag: 'p',
			content: 'TBA'
		}]
...

    {
        ...
        person: 'Fabian Steiner, Tobias Prinz, and Peihong Yuan (Chair for Communications Engineering, TUM)',
		body: [{
			tag: 'p',
...

    {
        ...
        time: '16:00-16:45',
        title: 'TBA',
        person: 'Touraj Soleymani (Chair of Information-oriented Control, TUM)',
		body: [{
			tag: 'p',
			content: 'TBA'
		}]
